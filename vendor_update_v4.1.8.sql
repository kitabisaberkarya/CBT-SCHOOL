...
-- Versi: 4.1.8 — Fix KRITIS: sinkronisasi spreadsheet tidak lagi menghapus data
-- SHA256: fa8a773dd19609102a3494c5c617b466a1a4e312d0b9069b84d257eabc107e6c
-- =====================================================================
...
INSERT INTO app_versions (
  ...
  'Fix KRITIS: sinkronisasi spreadsheet tidak lagi menghapus data yang sudah diimport. 2-phase sync: Fase 1 = insert/update via admin_import_users (chunked), Fase 2 = hapus siswa lama via sync_delete_removed_students (sekali). Tambahan: tabel Riwayat Sinkronisasi Update di menu Lisensi.',
  '-- =====================================================================
