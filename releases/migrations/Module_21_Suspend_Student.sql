...
GRANT EXECUTE ON FUNCTION admin_suspend_student(UUID, BOOLEAN) TO authenticated;
GRANT EXECUTE ON FUNCTION admin_suspend_student(UUID, BOOLEAN) TO service_role;
GRANT EXECUTE ON FUNCTION admin_suspend_student(UUID, BOOLEAN) TO anon;
