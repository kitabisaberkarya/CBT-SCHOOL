-- ============================================================
-- CBT SCHOOL ENTERPRISE — SQL Migration v4.0.8
-- Tanggal  : 2026-03-13
-- Keterangan: Kumulatif semua perubahan database sejak v4.0.6
--             (termasuk seluruh isi v4.0.7)
...
--     Perbaiki langsung semua guru yang email-nya belum ada @teacher.
-- ─────────────────────────────────────────────────────────────
DO $$
...
-- ─────────────────────────────────────────────────────────────
-- [7] Fitur: Konfigurasi IP Address Server Manual
...
-- ============================================================
-- SELESAI — Migration v4.0.8 applied successfully
-- Mencakup: v4.0.7 (fix import guru, sesi ujian) +
--           v4.0.8 (fix equation editor, konfigurasi IP server)
-- ============================================================
