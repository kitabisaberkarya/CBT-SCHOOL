...
--   2. Insert v4.1.7b dengan download_url + sql_migration
...
-- Step 2: Insert versi 4.1.7b
-- GANTI URL DI BAWAH dengan URL GitHub Release yang sudah Anda upload
INSERT INTO app_versions (
  ...
  'Fix import massal 1000+ siswa, mode jaringan ujian offline/online, manajemen Cloudflare Tunnel, fix exam_network_mode hardcode',
  '-- =====================================================================
...
SELECT id, version, is_active, created_at,
       ...
       LENGTH(sql_migration) AS sql_bytes
FROM app_versions
WHERE application_id = 'cbtschool'
