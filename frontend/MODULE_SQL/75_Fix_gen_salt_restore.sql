-- =============================================================================
-- FIX: Restore gagal "function gen_salt(unknown) does not exist"
-- CBT School Enterprise
-- Dibuat: 2026-03-07
--
-- Root cause: admin_restore_data memanggil crypt() dan gen_salt() tanpa prefix
-- schema, sedangkan pgcrypto di-install di schema 'extensions'.
-- Fix: gunakan extensions.crypt() dan extensions.gen_salt() secara eksplisit.
-- =============================================================================
