                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            {activeTab === 'teacher' && <th className="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Password</th>}
                        ...
                        {isLoading ? (
                            ...
                            filteredUsers.map(user => (
                                <tr key={user.id} className="hover:bg-gray-50 transition">
                                    ...
                                    {activeTab === 'teacher' && (
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className="font-mono text-xs bg-yellow-50 border border-yellow-200 text-yellow-800 px-2 py-1 rounded">
                                                {(user as any).password_text || '—'}
                                            </span>
                                        </td>
                                    )}
