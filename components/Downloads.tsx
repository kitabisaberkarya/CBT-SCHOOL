...
const Downloads: React.FC = () => {
  ...
  const downloadUrl = "https://drive.google.com/uc?export=download&id=1-3ExAIW37L70PyahRiXtYeQp-XVcJOpS";
  ...
  const content = {
    id: {
      ...
      subtitle: "VHD CBT SCHOOL V412_120426_1348.rar",
