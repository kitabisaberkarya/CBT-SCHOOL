...
const Downloads: React.FC = () => {
  ...
  const downloadUrl = "https://drive.google.com/uc?export=download&id=1S7Fv1eGaYXqQoj-A7UhJYZbRKzDpu4oJ";
  ...
  const content = {
    id: {
      ...
      subtitle: "VHD CBT SCHOOL V413_130426_0939.rar",
