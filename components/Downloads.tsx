...
const Downloads: React.FC = () => {
  ...
  const downloadUrl = "https://drive.google.com/uc?export=download&id=1ZLJ20K2unYdDI2U1Ic-VgN2Lmdey7aMl";
  ...
  const content = {
    id: {
      ...
      subtitle: "VHD CBT SCHOOL V417a.rar",
