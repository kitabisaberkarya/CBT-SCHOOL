  ...
  const steps = [
    ...
    },
    {
      ...
      instructions: [
        ...
        "Cari dan pilih file 'VHD CBT SCHOOL V414_170426_2204.VDI' (atau .VHD) yang sudah Anda unduh.",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-white/5 p-6 rounded-2xl border border-slate-200 dark:border-white/10">
              ...
              <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
                ...
                <li className="flex items-start gap-2"><CheckCircle2 size={16} className="text-green-500 mt-0.5 shrink-0" /> File VHD: VHD CBT SCHOOL V414_170426_2204</li>
              </ul>
            </div>
